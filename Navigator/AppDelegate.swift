...
//  Navigator
//
//  Created by Douglas Eveland on 2/11/18.
//  Copyright © 2018 Douglas Eveland. All rights reserved.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        // application state information to restore your application to its current state in case it
        // is terminated later.
